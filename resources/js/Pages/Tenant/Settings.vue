...
import { Building2, IndianRupee, Shield, FileImage, ChevronRight } from 'lucide-vue-next';
            ...
            <div class="card">
                ...
                <div class="mb-5">
                    ...
                    <div v-if="form.pf_enabled" class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="pulsara-label">Employee Rate (%)</label>
                            <input v-model="form.pf_employee_rate" type="number" step="0.01" class="pulsara-input" />
                        </div>
                        <div>
                            <label class="pulsara-label">Employer Rate (%)</label>
                            <input v-model="form.pf_employer_rate" type="number" step="0.01" class="pulsara-input" />
                        </div>
                        <div>
                            <label class="pulsara-label">Basic Cap (₹)</label>
                            <input v-model="form.pf_basic_cap" type="number" class="pulsara-input" />
                            <p class="mt-1 text-[10px] text-ink-3">PF calculated on basic up to this cap</p>
                        </div>
                        <div>
                            <label class="pulsara-label">PF Establishment Code</label>
                            <input v-model="form.pf_establishment_code" class="pulsara-input font-mono" placeholder="MH/MUM/12345" />
                        </div>
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div v-if="form.esi_enabled" class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="pulsara-label">Employee Rate (%)</label>
                            <input v-model="form.esi_employee_rate" type="number" step="0.01" class="pulsara-input" />
                        </div>
                        <div>
                            <label class="pulsara-label">Employer Rate (%)</label>
                            <input v-model="form.esi_employer_rate" type="number" step="0.01" class="pulsara-input" />
                        </div>
                        <div>
                            <label class="pulsara-label">Gross Threshold (₹)</label>
                            <input v-model="form.esi_gross_threshold" type="number" class="pulsara-input" />
                            <p class="mt-1 text-[10px] text-ink-3">ESI applies only if gross ≤ this amount</p>
                        </div>
                        <div>
                            <label class="pulsara-label">ESI Establishment Code</label>
                            <input v-model="form.esi_establishment_code" class="pulsara-input font-mono" />
                        </div>
                    </div>
                    <div v-else class="rounded-[10px] bg-bg-3 border border-frost-1 px-4 py-4 text-center">
                ...
                <!-- PT -->
                <div>
                    <label class="pulsara-label">Professional Tax (₹/month)</label>
                    <div class="flex items-center gap-3">
                        <input v-model="form.pt_amount" type="number" step="1" class="pulsara-input w-32" />
