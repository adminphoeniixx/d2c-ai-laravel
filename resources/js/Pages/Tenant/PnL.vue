...
<TenantLayout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
        <div class="kpi-card">
            ...
            <div class="kpi-value text-emerald">{{ ((revenue - cogs) / revenue * 100).toFixed(1) }}%</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Operating Margin</div>
            <div class="kpi-value text-amber">{{ ((revenue - cogs - totalExpenses) / revenue * 100).toFixed(1) }}%</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Ad Spend / Revenue</div>
            <div class="kpi-value">{{ ((expenses.ads || 0) / revenue * 100).toFixed(1) }}%</div>
        </div>
    </div>
</TenantLayout>
</template>
