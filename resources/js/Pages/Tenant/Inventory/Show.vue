    ...
    <div v-if="showAdjust" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" @click.self="showAdjust = false">
        <div class="card w-full max-w-sm mx-4">
            ...
            <form @submit.prevent="submit" class="space-y-3">
                ...
                <div><label class="pulsara-label">Quantity</label><input v-model.number="form.quantity" type="number" min="1" class="pulsara-input" /></div>
                <div><label class="pulsara-label">Notes</label><input v-model="form.notes" class="pulsara-input" placeholder="Reason…" /></div>
