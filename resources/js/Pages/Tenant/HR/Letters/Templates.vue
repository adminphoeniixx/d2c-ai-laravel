    ...
    <div v-if="showEditor" class="card mb-5">
        ...
        <form @submit.prevent="save" class="space-y-3">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                    <label class="pulsara-label">Template Name</label>
                    <input v-model="form.name" class="pulsara-input" placeholder="e.g. Appointment Letter v2" />
                </div>
                <div>
            ...
            <div>
                <label class="pulsara-label">Template Body (HTML with placeholders)</label>
                <textarea v-model="form.body" class="pulsara-input font-mono text-[12px]" rows="20" placeholder="Write your letter template here using HTML and {{placeholders}}..."></textarea>
