...
<TenantLayout>
    ...
    <div v-if="gstConfigured" class="card mb-5">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-[13px]">
            <div>
                <span class="pulsara-label">GSTIN</span>
                <div class="font-mono text-brand-300 text-[14px]">{{ company.gstin }}</div>
            </div>
            <div>
                <span class="pulsara-label">Registered State</span>
                <div class="text-ink">{{ company.registered_state_code }}</div>
            </div>
            <div>
                <span class="pulsara-label">Business Category</span>
                <div class="text-ink capitalize">{{ company.business_category }}</div>
            </div>
            <div>
                <span class="pulsara-label">Default GST Rate</span>
    ...
    <div class="card mb-5">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div class="flex items-center gap-2">
                ...
                <input v-model="fromDate" type="date" class="pulsara-input w-40 text-[12px]" @change="applyFilter" />
                <span class="text-[12px] text-ink-3 font-mono">TO</span>
                <input v-model="toDate" type="date" class="pulsara-input w-40 text-[12px]" @change="applyFilter" />
            </div>
